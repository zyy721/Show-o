...
if __name__ == '__main__':
    ...
    test_llama_annotation = json.load(open('data/test_llama.json', "r"))
    ...
    index = 38
    image_path = test_llama_annotation[index]['image'][2]
    image_ori = Image.open(image_path).convert("RGB")

    image_ori.save('infer_tmp_0.jpg')
    ...
    def expand2square(pil_img, background_color):
        ...
        if width == height:
            ...
            return result
    # image_ori = expand2square(image_ori, tuple(int(x*255) for x in clip_image_processor.image_mean))
    image_ori = expand2square(image_ori, tuple(int(x*255) for x in [1, 1, 1]))


    image_ori.save('infer_tmp_1.jpg')
    ...
    question = 'Please provide the bounding box coordinate of the region this sentence describes: a white sedan.'
    answer = test_llama_annotation[index]['conversations'][1]['value']
    print(answer)
